...
func TestActivation(t *testing.T) {
	tests := []struct {
		...
		// Everything set.
		{"Sun Jul 15 08:30 2012", "0 30 08 ? 7 0", true},
		{"Sun Jul 15 08:30 2012", "0 30 08 15 7 ?", true},
		{"Mon Jul 16 08:30 2012", "0 30 08 ? 7 0", false},
		{"Mon Jul 16 08:30 2012", "0 30 08 15 7 ?", false},

		// Test interaction of DOW and DOM.
		// If both are specified, then only one needs to match.
		{"Sun Jul 15 00:00 2012", "0 * * 1,15 * 0", true},
		{"Fri Jun 15 00:00 2012", "0 * * 1,15 * 0", true},
		{"Wed Aug 1 00:00 2012", "0 * * 1,15 * 0", true},

		// However, if one has a star, then both need to match.
		{"Sun Jul 15 00:00 2012", "0 * * * * 1", false},
		{"Sun Jul 15 00:00 2012", "0 * * */10 * 0", false},
		{"Mon Jul 9 00:00 2012", "0 * * 1,15 * *", false},
		{"Sun Jul 15 00:00 2012", "0 * * 1,15 * *", true},
		{"Sun Jul 15 00:00 2012", "0 * * */2 * 0", true},
	}
...
func TestNext(t *testing.T) {
	runs := []struct {
		...
		{"Mon Jul 9 23:35:51 2012", "15/35 20-35/15 * 9-20 7 *", "Wed Jul 10 00:20:15 2012"},

		// Wrap around years
		{"Mon Jul 9 23:35 2012", "0 0 0 * 2 1", "Mon Feb 4 00:00 2013"},
		{"Mon Jul 9 23:35 2012", "0 0 0 * 2 1/2", "Fri Feb 1 00:00 2013"},

		// Wrap around minute, hour, day, month, and year
		{"Mon Dec 31 23:59:45 2012", "0 * * * * *", "Tue Jan 1 00:00:00 2013"},

		// Leap year
		{"Mon Jul 9 23:35 2012", "0 0 0 29 2 ?", "Mon Feb 29 00:00 2016"},

		// Daylight savings time 2am EST (-5) -> 3am EDT (-4)
		{"2012-03-11T00:00:00-0500", "0 30 2 11 3 ?", "2012-03-11T02:30:00-0500"},
		...
		// 1am nightly job
		{"2012-03-11T00:00:00-0500", "0 0 5 * * ?", "2012-03-11T05:00:00-0500"},
		{"2012-03-11T01:00:00-0500", "0 0 1 * * ?", "2012-03-12T01:00:00-0500"},

		// // 2am nightly job (skipped)
		{"2012-03-11T00:00:00-0500", "0 0 2 * * ?", "2012-03-11T02:00:00-0500"},

		// Daylight savings time 2am EDT (-4) => 1am EST (-5)
		{"2012-11-04T00:00:00-0400", "0 30 2 04 11 ?", "2012-11-04T02:30:00-0400"},
		{"2012-11-04T01:45:00-0400", "0 30 1 04 11 ?", "2013-11-04T01:30:00-0400"},
		...
		{"2012-11-04T01:00:00-0400", "0 0 1 * * ?", "2012-11-05T01:00:00-0400"},
		{"2012-11-04T01:00:00-0500", "0 0 1 * * ?", "2012-11-05T01:00:00-0500"},

		// 2am nightly job
		{"2012-11-04T00:00:00-0500", "0 0 2 * * ?", "2012-11-04T02:00:00-0500"},
		{"2012-11-04T02:00:00-0500", "0 0 2 * * ?", "2012-11-05T02:00:00-0500"},

		// 3am nightly job
		{"2012-11-04T00:00:00-0400", "0 0 3 * * ?", "2012-11-04T03:00:00-0400"},
		{"2012-11-04T03:00:00-0500", "0 0 3 * * ?", "2012-11-05T03:00:00-0500"},

		// Unsatisfiable
		{"Mon Jul 9 23:35 2012", "0 0 0 30 2 ?", ""},
		{"Mon Jul 9 23:35 2012", "0 0 0 31 4 ?", ""},
	}
	...
	for _, c := range runs {
		...
		if !actual.Equal(expected) {
			...
			// fmt.Println(sched.Next(actual).String())
